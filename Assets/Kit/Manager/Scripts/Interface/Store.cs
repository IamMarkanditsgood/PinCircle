...
#region Corountines
    ...
    void Chance(int i)
    {
        ...
        {
            print("hide shop");
           CanvasManager.inst.OpenMainMenu();
        }
    }
    #endregion
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class Store_Editor : Editor
{
    ...
    int
        ...
        add = 100,
        price = 100;
    string[] dataCache = { "Coins", "PlayerIndex", "isRandom", "Items" };
    ...
    public void SetSettings()
    {
        ...
        string gameName = EditorSceneManager.GetActiveScene().name;
        if (script.data.Length != dataCache.Length) 
        {
            script.data = new string[dataCache.Length];
        }
        for (int i = 0; i < script.data.Length; i++)
        {
            string data = gameName + dataCache[i];
            if (data != script.data[i])
            {
                script.data[i] = data;
            }
        }
